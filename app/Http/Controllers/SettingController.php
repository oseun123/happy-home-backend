        ...
        if ($key === 'nationality') {
            ...
            foreach ($countries as $country) {
                ...
                foreach ($country->states as $state) {
                    ...
                    $result[$countryName]['states'][] = $stateName;
                    $result[$countryName]['lgas'][$stateName] = [];

                    foreach ($state->cities as $city) {
                        $result[$countryName]['lgas'][$stateName][] = $city->name;
                    }
                }
            }

            // Now override Nigeria with trusted $nig_data
            $result['Nigeria'] = $nig_data['Nigeria'];
